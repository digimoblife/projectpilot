      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-2xl max-w-3xl w-full p-6 space-y-4 my-8 max-h-[90vh] flex flex-col animate-fadeIn">
        ...
        <div className="space-y-4 overflow-y-auto pr-1 flex-1">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 text-xs bg-slate-50 border border-slate-200 rounded-xl text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-slate-900/10 focus:border-slate-900 transition-all"
            />
          </div>
        </div>
        ...
        <div className="pt-3 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-2.5 shrink-0">
          <button
            ...
            className="w-full sm:w-auto px-4 py-2 bg-rose-50 hover:bg-rose-100 text-rose-800 font-semibold text-xs rounded-xl border border-rose-200 active:scale-[0.98] transition-all flex items-center justify-center gap-1.5 disabled:opacity-50 cursor-pointer"
          >
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
            ...
            {isEditing ? (
              <button
                ...
                className="px-5 py-2 bg-slate-900 hover:bg-black text-white font-semibold text-xs rounded-xl shadow-xs active:scale-[0.98] transition-all flex items-center justify-center gap-1.5 disabled:opacity-50 cursor-pointer"
              >
