      ...
      <div className="flex items-center justify-between border-b border-slate-200 pb-3">
        <div className="flex items-center gap-2">
          ...
          >
            ...
            <span>Log Keputusan / Decision Log ({decisions.length})</span>
          </button>
        </div>
          ...
          {activeTab === "requirements" && (
            <>
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3.5 py-1.5 bg-blue-50 hover:bg-blue-100 text-blue-700 border border-blue-200 text-xs font-semibold rounded-lg shadow-xs transition-colors disabled:opacity-50"
              >
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3.5 py-1.5 bg-amber-50 hover:bg-amber-100 text-amber-700 border border-amber-200 text-xs font-semibold rounded-lg shadow-xs transition-colors disabled:opacity-50"
              >
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3.5 py-1.5 bg-purple-50 hover:bg-purple-100 text-purple-700 border border-purple-200 text-xs font-semibold rounded-lg shadow-xs transition-colors"
              >
