        ...
        <div className="flex flex-col gap-2 items-end">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3.5 py-1.5 bg-purple-600 hover:bg-purple-700 text-white text-xs font-semibold rounded-lg shadow-xs transition-colors disabled:opacity-50"
            >
              <Sparkles className="w-3.5 h-3.5" />
              <span>{isAILoading ? "AI Menyiapkan Task..." : "AI Auto Breakdown Task"}</span>
            </button>
          </div>

          {/* Tier 2: Manual Actions & View Mode */}
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-1 px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold rounded-lg shadow-xs transition-colors"
            >
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="pt-1.5 border-t border-slate-100 flex items-center justify-between text-[11px] text-slate-500">
                          ...
                          <span className="font-mono text-[9px] font-semibold text-slate-600 bg-slate-50 px-1.5 py-0.5 rounded border border-slate-100 shrink-0 whitespace-nowrap">
                            {task.estimated_hours != null ? `${task.estimated_hours} Hari` : "0 Hari"}
                          </span>
                        </div>
